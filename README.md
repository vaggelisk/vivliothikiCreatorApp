...
- Ο οδηγός χρήσης βρίσκεται στο [http://localhost:3000/scanner](http://localhost:3000/scanner) και η λειτουργία σάρωσης στο [http://localhost:3000/scanner/scan](http://localhost:3000/scanner/scan).
